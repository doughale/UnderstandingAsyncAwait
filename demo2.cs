...
public class CoffeeMaker
{
    ...
    private void DoSomethingSeq(string name, int waitMs)
    {
        Console.WriteLine($"[{Now()}] [T{Tid()}] START  {name,-18} (wait {waitMs} ms)");
    ...
    public void BrewCoffee() => DoSomethingSeq(nameof(ActivityMs.BrewCoffee), ActivityMs.BrewCoffee);
    public void PourCoffee() => DoSomethingSeq(nameof(ActivityMs.PourCoffee), ActivityMs.PourCoffee);
